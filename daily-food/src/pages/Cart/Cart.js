...
const Cart = () => {
  const { cart, deleteCartRetail, cartRetail, deleteCart, deleteAll } =
    useCart();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (information) => {
      const dataOrders = {
        ...
        cartRetail: JSON.stringify(cartRetail),
  ...
  const dataDistrict = UseFetch(
    `https://esgoo.net/api-tinhthanh/2/${selectProvince}.htm`
  );
  const dataWards = UseFetch(
    `https://esgoo.net/api-tinhthanh/3/${selectDistrict}.htm`
  );
              ...
              <Row>
                <Col lg={7}>
                  ...
                  <div className="s-cart-form">
                        ...
                        <Row>
                          ...
                          <Col xs={4}>
                            ...
                            {formik.touched.wards && formik.errors.wards ? (
                              <div className="error">{formik.errors.wards}</div>
                            ) : null}
                          </Col>
                        </Row>
                      </div>
                    ...
                    <div
                      className={`${
                        choosePayment === 1 ? "s_radioActive" : "s_radio"
                      }`}
                    ...
                    <div
                      className={`${
                        choosePayment === 2 ? "s_radioActive" : "s_radio"
                      }`}
                    ...
                    >
                      ...
                      <div
                        className={`s_radio_right ${
                          choosePayment === 2 && "active"
                        }`}
                      >
                        <img
                      ...
                      <div className="s-left_title">
                        <div className="s-left_title_left">
                          <h2>
                            {
                              <i
                                className={`fa-solid ${arrayIcon[item.title]}`}
                              ></i>
                            }
                            {item.title}
                          </h2>
                          ...
                          <div className="s-item_top">
                            <div className="s-item_top_left">
                              ...
                              <h3>
                                ...
                                <span>${Math.floor(itemDetail.price)}</span>
                              </h3>
                            </div>
                            <i
                              className="fa-regular fa-trash-can"
                              onClick={() => deleteCart(itemDetail.daymenu_id)}
                            ></i>
                          </div>
                    ...
                    <div className="s-left" key={item.foodmenu_id}>
                      <div className="s-item" key={item.foodmenu_id}>
                        <div className="s-item_top">
                          ...
                          <i
                            className="fa-regular fa-trash-can"
                            onClick={() => deleteCartRetail(item.foodmenu_id)}
                          ></i>
                        </div>
                      </div>
                      <p className="s-left_totalprice">
                        ...
                        <span>
                          ...
                          {cartRetail.reduce((total, current) => {
                            return (
                              total + Number(current.price * current.quantity)
                            );
                          }, 0)}
                        </span>
                      </p>
            ...
            <Row>
              <Col lg={6}>
                <p className="s-totalFixed_text">
                  If you don't want to order Website , you can call hotline{" "}
                  <span>0974200611</span>
                </p>
              </Col>
              <Col lg={6}>
          ...
          <Modal show={show}>
            ...
            <Modal.Body>
              <div className="notification">
                Bill of your lading code:{" "}
                <span>" {informationOrder.idOrders} "</span>
              </div>
              <div className="notification">
